...
Dodo Data Center 的目标是把公开比赛数据整理成可解释、可筛选、带样本范围的数据产品：玩家可以查看最近比赛、英雄使用和表现趋势，也可以查询英雄、物品与当前地图资料。
...
地图页当前只包含版本化静态资料，不包含实时热图或推荐眼位。

## 技术架构

```text
OpenDota / Dota 2 official updates / curated constants
        |
        v
...
packages/dota-data   OpenDota/官方更新适配、账号解析与质量标准化
