    ...
    abilities: [
      {
        ...
        attributes: [{ label: "Mana burn", value: "28" }],
        slot: 0,
        type: "basic",
      },
    ],
    ...
    abilities: [
      {
        ...
        description: "Deterministic test-only ability.",
        attributes: [{ label: "Armor", value: "+12" }],
        slot: 0,
        type: "basic",
      },
    ],
    ...
    abilities: [
      {
        ...
        description: "Deterministic test-only ability.",
        attributes: [{ label: "Damage reduction", value: "30%" }],
        slot: 0,
        type: "basic",
      },
    ],
...
const updateSeed: UpdateReleaseDetail = {
  ...
  groups: [
    ...
    },
    {
      ...
      subsection: "overview",
      entityId: "1",
      entityName: "Seed Anti-Mage",
      relatedAbilityId: null,
      title: null,
      notes: [{ text: "Seed base agility increased.", info: null, indentLevel: 1 }],
    },
    {
      kind: "item",
      subsection: "overview",
      entityId: "1",
      entityName: "Seed Blink Dagger",
      relatedAbilityId: null,
      title: null,
      notes: [{ text: "Seed cost reduced.", info: null, indentLevel: 1 }],
    },
    {
      kind: "neutral_item",
      subsection: "overview",
      entityId: "1",
      entityName: "Seed Neutral Blink Dagger",
      relatedAbilityId: null,
      title: null,
      notes: [{ text: "Seed neutral effect adjusted.", info: null, indentLevel: 1 }],
    },
  ],
};
